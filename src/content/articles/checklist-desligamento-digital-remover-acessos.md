---
title: "Funcionário ou freelancer saiu: checklist para remover acessos digitais"
description: "Transfira arquivos, propriedade e responsabilidades antes de revogar e-mails, redes, domínio, nuvem e outros acessos de quem deixou o negócio."
...
draft: false
featured: false
seoTitle: "Checklist para remover acessos de quem saiu do negócio"
socialTitle: "Alguém saiu da equipe? Remova os acessos sem perder os ativos"
socialDescription: "Um checklist para transferir propriedade, preservar dados e revogar permissões sem deixar portas abertas nem apagar o que pertence ao negócio."
image: "/assets/editorial/checklist-desligamento-digital-remover-acessos.webp"
imageAlt: "Dono de pequeno negócio revisa uma lista de acessos digitais no notebook e em papel enquanto uma cadeira vazia representa a saída de um colaborador"
video:
  id: "WN-QjGhOyjU"
  title: "How to Offboard Employees in Google Workspace – Maintain Data Security"
  source: "Damson Cloud"
faqQuestions:
  - "Devo trocar todas as senhas quando alguém sai da empresa?"
  - "Posso excluir o e-mail do ex-funcionário imediatamente?"
  - "O que fazer quando o freelancer usava a própria conta pessoal?"
  - "Preciso remover acesso no mesmo dia?"
  - "Como evitar esse problema no próximo contrato?"
faqAnswers:
  - "Não automaticamente. Primeiro identifique quais credenciais foram compartilhadas. Onde a plataforma usa contas individuais, o correto é revogar o usuário e revisar sessões e permissões."
  - "Antes, verifique propriedade de arquivos, mensagens necessárias, agenda, contas vinculadas e dados que precisam ser transferidos ou preservados. Excluir cedo demais pode apagar ou tornar inacessível informação do negócio."
...
O guia [Organize os acessos digitais do seu negócio antes de perder uma conta](/guias/organize-os-acessos-digitais-do-seu-negocio/) fornece a base para esse mapa.
...
No Google Workspace, a documentação oficial orienta administradores a [transferir dados importantes antes de excluir um usuário](https://support.google.com/cloudidentity/answer/33314?hl=pt-BR&ref_topic=7559006). Dependendo da edição e do tipo de conta, arquivos e outros dados podem exigir ações específicas.
...
1. pesquise serviços relevantes;
2. transfira dados que pertencem à empresa;
3. mude responsáveis e recuperações;
4. avalie se mensagens futuras precisam ser redirecionadas por um período;
5. remova o usuário conforme a política da ferramenta.
...
Se a saída coincide com troca de aparelho ou responsável, vale revisar [como ativar autenticação em dois fatores sem perder acesso à própria conta](/guias/autenticacao-em-dois-fatores-sem-perder-acesso/).

## Aplique o princípio do menor privilégio

A [CISA recomenda revisar contas e aplicar menor privilégio](https://www.cisa.gov/cross-sector-cybersecurity-performance-goals): cada pessoa deve ter apenas o acesso necessário para cumprir sua função.
...
1. confirme que ninguém precisou reativar acesso por falta de informação;
2. revise erros de permissão;
3. confira se arquivos estão realmente acessíveis;
4. verifique se novas notificações ainda chegam para a pessoa antiga;
5. atualize o inventário;
6. documente o que faltou no procedimento.
...
O guia [Seu negócio sofreu um incidente digital: o que fazer antes de tentar consertar tudo](/guias/seu-negocio-sofreu-um-incidente-digital-o-que-fazer-antes-de-tentar-consertar-tudo/) explica a diferença entre conter, registrar e recuperar.
...
1. abra o inventário de acessos;
2. pesquise o e-mail da pessoa nos principais painéis;
3. confira Drive e redes;
4. revise domínio, anúncios e pagamentos;
5. encerre sessões;
6. atualize recuperações;
7. documente o que encontrou.
...
- [Google Workspace — Excluir ou remover um usuário da organização](https://support.google.com/cloudidentity/answer/33314?hl=pt-BR&ref_topic=7559006)
- [Google Workspace — Remover pessoas da sua equipe](https://support.google.com/a/users/answer/11559716?hl=pt-BR)
- [CISA — Cybersecurity Performance Goals](https://www.cisa.gov/cross-sector-cybersecurity-performance-goals)
- [CISA — Recursos para pequenos e médios negócios](https://www.cisa.gov/small-and-medium-sized-business-resources)
