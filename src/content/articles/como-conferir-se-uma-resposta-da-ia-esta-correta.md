---
title: "Como conferir se uma resposta da inteligência artificial está correta"
description: "Aprenda a verificar fatos, fontes, datas, números e citações de respostas de IA antes de usar o conteúdo em decisões, atendimento ou publicação."
...
draft: false
featured: false
seoTitle: "Como conferir se uma resposta da IA está correta"
socialTitle: "A resposta da IA parece perfeita. Isso não prova que está correta"
socialDescription: "Use um protocolo de verificação para separar fato, inferência e hipótese antes de publicar ou decidir com base em inteligência artificial."
image: "/assets/editorial/como-conferir-se-uma-resposta-da-ia-esta-correta.webp"
imageAlt: "Profissional compara criticamente uma resposta de inteligência artificial no notebook com documentos e fontes oficiais abertas em outra tela"
video:
  id: "cfqtFvWOfg0"
  title: "Why Large Language Models Hallucinate"
  source: "IBM Technology"
faqQuestions:
  - "Se a IA cita uma fonte, posso confiar?"
  - "Pesquisar na web elimina alucinações?"
  - "Quais respostas precisam de mais verificação?"
  - "Posso usar IA para cálculo?"
  - "Quando a IA pode ser usada sem grande verificação?"
faqAnswers:
  - "Não automaticamente. Abra a fonte, confirme que existe e verifique se ela realmente sustenta a afirmação feita."
  - "Não. A busca melhora acesso a informação atual, mas ainda é necessário avaliar qualidade, data, contexto e relação entre a fonte e a resposta."
...
A própria [OpenAI alerta que o ChatGPT pode soar confiante mesmo quando está errado](https://help.openai.com/pt-br/articles/8313428-does-chatgpt-tell-the-truth) e recomenda verificar informações importantes em fontes confiáveis.

O [NIST trata confabulação como um risco relevante em IA generativa](https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-generative-artificial-intelligence).
...
1. abra;
2. confirme existência;
3. veja autor;
4. veja data;
5. encontre a afirmação;
6. leia contexto;
7. confirme se a conclusão respeita o texto.
...
A [OpenAI recomenda prompts claros, específicos e com contexto suficiente](https://help.openai.com/pt-br/articles/10032626-prompt-engineering-best-practices-for-chatgpt).
...
1. abrir órgão oficial;
2. pesquisar número;
3. conferir ementa;
4. conferir vigência;
5. localizar trecho;
6. se a decisão for jurídica, pedir análise adequada.
...
O guia [Como usar IA para pesquisar concorrentes sem copiar](/guias/como-pesquisar-concorrentes-com-ia-sem-copiar/) aplica esse princípio a pesquisa competitiva.
...
O artigo [Use IA no negócio sem virar refém da tecnologia](/guias/use-ia-no-negocio-sem-virar-refem-da-tecnologia/) ajuda a organizar esse uso de forma sustentável.
...
1. Pegue uma resposta de IA que você pretende usar.
2. Marque todas as afirmações factuais.
3. Classifique o risco.
4. Abra as fontes primárias.
5. Verifique data e contexto.
6. Recalcule números.
7. Remova ou marque o que não foi confirmado.
8. Salve a versão aprovada fora da conversa.
...
2. confira domínio;
3. leia o conteúdo;
4. confirme que é público quando precisa ser;
5. teste em janela anônima se o leitor externo precisa acessar.
...
- [OpenAI — Práticas recomendadas de engenharia de prompt](https://help.openai.com/pt-br/articles/10032626-prompt-engineering-best-practices-for-chatgpt)
