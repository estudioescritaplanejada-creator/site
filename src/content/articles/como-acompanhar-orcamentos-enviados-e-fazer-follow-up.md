---
title: "Como acompanhar orçamentos enviados e fazer follow-up sem esquecer ninguém"
description: "Crie um controle simples de propostas, status, próxima ação e data de retorno para fazer follow-up sem depender da memória nem parecer cobrança."
...
draft: false
featured: false
seoTitle: "Como acompanhar orçamentos e fazer follow-up"
socialTitle: "Orçamento enviado não pode depender da sua memória"
socialDescription: "Organize propostas e próximas ações para retomar clientes no momento certo sem transformar follow-up em cobrança."
image: "/assets/editorial/como-acompanhar-orcamentos-enviados-e-fazer-follow-up.webp"
imageAlt: "Profissional acompanha propostas abertas numa planilha enquanto prepara no celular a próxima mensagem de retorno a um cliente"
video:
  id: "QPt7tjrQmPo"
  title: "Cliente Sumiu Depois do Orçamento? Use Este Roteiro de Follow-up para Retomar a Venda"
  source: "Janderson Santos — Mago das Vendas"
faqQuestions:
  - "Quanto tempo devo esperar antes do primeiro follow-up?"
  - "Follow-up é a mesma coisa que cobrança?"
  - "Quantas vezes devo insistir?"
  - "Preciso de CRM para fazer follow-up?"
  - "O que registrar quando o cliente recusa?"
faqAnswers:
  - "Não existe prazo universal. Considere o combinado, a urgência do serviço e o ciclo de decisão. Quando possível, defina a data de retomada no momento em que envia a proposta."
  - "Não. O objetivo é retomar a decisão e esclarecer o próximo passo. Cobrança trata de pagamento devido; follow-up comercial trata de oportunidade ainda em decisão."
...
O Sebrae, em material sobre marketing e vendas, trata o follow-up como forma de [retomar orçamento ou proposta com contexto e próxima ação](https://sebrae.com.br/content/dam/portal-sebrae/na/midias/documentos/pdfs/ebook_prompts-redes-sociais-marketing-vendas.pdf).
...
Veja [Atendimento em vários canais: como não perder mensagens, arquivos e decisões](/guias/atendimento-em-varios-canais-sem-perder-mensagens/).

## Quando sair da planilha

Se o volume crescer, compare [WhatsApp Business, planilha ou CRM](/guias/whatsapp-planilha-ou-crm-quando-mudar/).
...
Na revisão semanal, use também [Fechamento semanal do pequeno negócio](/guias/fechamento-semanal-do-pequeno-negocio-o-que-revisar-antes-de-comecar-outra-semana/).
...
Por isso, quando uma proposta vira venda, não deixe o registro morrer. Transfira a relação para uma rotina de [pós-venda simples](/guias/pos-venda-simples-como-acompanhar-o-cliente/).
...
- [Sebrae — Pack de prompts para redes sociais, marketing e vendas](https://sebrae.com.br/content/dam/portal-sebrae/na/midias/documentos/pdfs/ebook_prompts-redes-sociais-marketing-vendas.pdf)
- [Sebrae — Venda mais com o WhatsApp](https://sebrae.com.br/sites/PortalSebrae/ufs/ba/artigos/venda-mais-com-o-whatsapp-estrategias-para-empresas-em-expansao%2C36ea1c09edf78910VgnVCM1000001b00320aRCRD)
