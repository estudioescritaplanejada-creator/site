---
title: "Como registrar alterações pedidas pelo cliente sem perder prazo, preço e versão"
description: "Separe correção, revisão e mudança de escopo; registre impacto, aprovação e versão para evitar retrabalho, prazo estourado e cobrança confusa."
...
draft: false
featured: false
seoTitle: "Como registrar alterações pedidas pelo cliente"
socialTitle: "O cliente pediu uma mudança. Registre antes de executar"
socialDescription: "Um método para avaliar impacto em escopo, prazo, preço e versão antes de transformar cada pedido em retrabalho."
image: "/assets/editorial/como-registrar-alteracoes-pedidas-pelo-cliente.webp"
imageAlt: "Freelancer compara duas versões de um projeto no notebook e anota impactos de prazo, preço e escopo antes de executar uma mudança pedida pelo cliente"
video:
  id: "OvPnLKER_lU"
  title: "Como tratar as mudanças em projetos"
  source: "Robson Camargo"
faqQuestions:
  - "Toda alteração deve aumentar o preço?"
  - "Preciso pedir aprovação por escrito?"
  - "WhatsApp serve como registro?"
  - "Como lidar com várias pequenas mudanças?"
  - "O que fazer quando o cliente pede algo fora do escopo?"
faqAnswers:
  - "Não. Primeiro compare o pedido com o escopo contratado e com as revisões já previstas. Algumas mudanças estão incluídas; outras alteram trabalho, prazo ou custo."
  - "É recomendável registrar o que mudou e a confirmação do cliente, especialmente quando existe impacto em prazo, preço ou entregável."
...
A [Asana define escopo como os limites que estabelecem metas, prazos e entregáveis](https://asana.com/pt/resources/project-scope). Independentemente da ferramenta, essa lógica ajuda autônomos a separar mudança legítima de expectativa não registrada.
...
A [documentação sobre pedidos de alteração da Asana](https://asana.com/pt/resources/change-order-template) destaca justamente a necessidade de analisar impacto em entregáveis, preço e cronograma antes da implementação.
...
Veja também [Como organizar pedidos, prazos e entregas sem depender da memória](/guias/como-organizar-pedidos-prazos-e-entregas-sem-depender-da-memoria/).
...
O guia [Atendimento em vários canais](/guias/atendimento-em-varios-canais-sem-perder-mensagens/) aprofunda essa centralização.
...
- [Asana — Guia rápido para definir o escopo do projeto](https://asana.com/pt/resources/project-scope)
- [Asana — Formulários de pedidos de alteração](https://asana.com/pt/resources/change-order-template)
- [Asana — Modelo de formulário para pedidos de mudança](https://asana.com/pt/templates/change-request-form)
- [Asana — O que são desvios de escopo](https://asana.com/pt/resources/what-is-scope-creep)
