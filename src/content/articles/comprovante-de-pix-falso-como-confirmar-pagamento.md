---
title: "Comprovante de Pix falso: como confirmar que o dinheiro entrou antes de entregar"
description: "Aprenda a conferir o recebimento do Pix no próprio banco, diferenciar comprovante de crédito e criar uma regra segura antes de liberar pedidos."
...
draft: false
featured: false
seoTitle: "Comprovante de Pix falso: como confirmar pagamento"
socialTitle: "Recebeu comprovante de Pix? Confirme antes de entregar"
socialDescription: "Um procedimento simples para não liberar pedidos com base apenas em print, PDF ou tela mostrada pelo pagador."
image: "/assets/editorial/comprovante-de-pix-falso-como-confirmar-pagamento.webp"
imageAlt: "Dona de pequeno negócio confere o recebimento do Pix no próprio celular antes de entregar um pedido embalado no balcão"
video:
  id: "sDX_wMeZ4kg"
  title: "O Pix é novo, mas os golpes são antigos"
  source: "Banco Central do Brasil"
faqQuestions:
  - "O comprovante de Pix confirma que o dinheiro entrou?"
  - "O Pix pode ficar demorando para cair?"
  - "Como saber se o Pix foi agendado em vez de pago?"
  - "O que fazer se alguém disser que fez Pix por engano?"
  - "O MED garante que eu receba de volta um Pix enviado num golpe?"
faqAnswers:
  - "Não. Para liberar produto ou serviço, confirme o crédito no seu próprio aplicativo ou extrato bancário. Imagem, PDF ou tela mostrada pelo pagador não substitui essa conferência."
  - "O Pix é um pagamento instantâneo, mas indisponibilidades e situações operacionais podem ocorrer. Se o crédito não aparece para você, não trate a imagem enviada pelo cliente como confirmação."
...
O [Banco Central orienta vítimas e usuários a conferir a movimentação no próprio ambiente bancário](https://www.bcb.gov.br/estabilidadefinanceira/pix-seguranca). A mesma lógica é útil para vendas: antes de liberar produto, confirme a movimentação no ambiente que você controla.
...
O Banco Central explica que o [Pix Cobrança](https://www.bcb.gov.br/estabilidadefinanceira/pix-cobranca) permite estruturar cobranças com QR Code e informações que facilitam a identificação e a conciliação.
...
O guia [Como organizar pedidos, prazos e entregas sem depender da memória](/guias/como-organizar-pedidos-prazos-e-entregas-sem-depender-da-memoria/) mostra como tirar informações importantes das conversas e colocá-las num lugar acompanhável.
...
A [orientação do Banco Central](https://www.bcb.gov.br/estabilidadefinanceira/pix-seguranca) é acionar a instituição pelo aplicativo e solicitar o MED o mais rápido possível quando houver suspeita de fraude.
...
Se a fraude começou por cobrança falsa, consulte também [Boleto falso e cobrança fraudulenta: como não cair nessa](/guias/boleto-falso-e-cobranca-fraudulenta/).
...
Se o negócio usa várias formas de cobrança, veja também [Pix, maquininha ou link de pagamento: qual faz sentido para o pequeno negócio?](/guias/pix-maquininha-ou-link-de-pagamento-como-escolher/).
