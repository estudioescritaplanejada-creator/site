---
title: "Pix, maquininha ou link de pagamento: qual faz sentido para o pequeno negócio?"
description: "Compare Pix, maquininha e link por venda presencial, parcelamento, taxas, prazo, segurança e conciliação para oferecer apenas o que faz sentido."
...
draft: false
featured: false
seoTitle: "Pix, maquininha ou link: como escolher"
socialTitle: "Pix, maquininha ou link? Compare antes de oferecer tudo"
socialDescription: "Escolha meios de pagamento pelo tipo de venda, parcelamento, custo, prazo e conciliação — não apenas pela taxa anunciada."
image: "/assets/editorial/pix-maquininha-ou-link-de-pagamento-como-escolher.webp"
imageAlt: "Pequeno comerciante avalia maquininha de cartão, celular e anotações financeiras diante de uma cliente no balcão"
video:
  id: "638IBdHeVHM"
  title: "Maquininha, PIX, link de pagamento, celular como maquininha… Tudo num só lugar!"
  source: "InfinitePay"
faqQuestions:
  - "Pix é sempre a opção mais barata?"
  - "Preciso oferecer cartão se já recebo Pix?"
  - "Link de pagamento é seguro?"
  - "Posso usar mais de um meio de pagamento sem complicar o financeiro?"
  - "Qual método devo oferecer primeiro?"
faqAnswers:
  - "Não necessariamente. Tarifas e serviços variam conforme instituição, tipo de conta e uso. Compare custo real, conciliação, prazo e necessidades do cliente."
  - "Não existe uma resposta única. Avalie se parcelamento, venda presencial e preferência do seu público justificam cartão além do Pix."
...
O [Banco Central descreve o Pix Cobrança](https://www.bcb.gov.br/estabilidadefinanceira/pix-cobranca) como instrumento que permite pagamentos imediatos e também cobranças com vencimento, conforme as funcionalidades oferecidas pela instituição.
...
O [Banco Central informa que pessoas jurídicas podem ser tarifadas em situações de envio e recebimento](https://www.bcb.gov.br/meubc/faqs/p/quanto-a-pessoa-juridica-paga-para-usar-o-pix), conforme regras e serviços envolvidos.
...
Veja [Comprovante de Pix falso: como confirmar que o dinheiro entrou antes de entregar](/guias/comprovante-de-pix-falso-como-confirmar-pagamento/).
...
O guia [Como saber se uma mensagem, um link ou um site é golpe](/guias/como-saber-se-mensagem-link-ou-site-e-golpe/) ajuda a reduzir esse risco.
...
2. registre forma;
3. confira valor;
4. confira recebimento;
5. registre taxa;
6. identifique pendências;
7. separe estornos.

O guia [Use IA para organizar as finanças sem ser especialista em números](/guias/use-ia-para-organizar-as-financas/) pode ajudar na estrutura de planilhas, mas cálculos e saldos precisam continuar sendo conferidos nos documentos e sistemas oficiais.
...
1. Liste como seus clientes pagaram nas últimas vendas.
2. Separe presencial e remoto.
3. Identifique quantos precisaram parcelar.
4. Levante taxa e prazo atuais das opções que você usa.
5. Calcule o trabalho de conciliação.
6. Elimine uma opção que não tem função, se houver.
7. Crie um fechamento simples por forma de pagamento.
...
- [Banco Central — Quanto a pessoa jurídica paga para usar o Pix](https://www.bcb.gov.br/meubc/faqs/p/quanto-a-pessoa-juridica-paga-para-usar-o-pix)
- [Banco Central — Segurança no Pix](https://www.bcb.gov.br/estabilidadefinanceira/pix-seguranca)
- [Banco Central — Sobre o Pix](https://www.bcb.gov.br/estabilidadefinanceira/pix-sobre)
